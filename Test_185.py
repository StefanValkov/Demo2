...
xpath_devops_department = '//*[@id="project-teams"]/div[1]/div[1]/a'
xpath_date = '//*[@id="pane3"]/div/div[3]/dl/div/div'
...
browser.find_element_by_xpath(xpath_devops_department).click()

time.sleep(4)
xpath_date = browser.find_element_by_xpath(xpath_date).text

time.sleep(4)

assert len(xpath_date) > 0, 'Issue' #checking if the date is available
browser.close()
